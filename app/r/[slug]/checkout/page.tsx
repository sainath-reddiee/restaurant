...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showGoogleLogin && !profile && (
        <div className="container mx-auto px-4 py-6 max-w-2xl">
          <Card className="border-orange-500 border-2">
            <CardHeader>
              <CardTitle>Sign in to Complete Order</CardTitle>
              <CardDescription>
                Quick and secure checkout with Google. Takes just 2 seconds!
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Button
                onClick={handleGoogleSignIn}
                className="w-full h-12 bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-900"
              >
              ...
              <p className="text-xs text-center text-muted-foreground">
                Your order details are saved. Sign in to complete checkout.
              </p>
            </CardContent>
          </Card>
        </div>
